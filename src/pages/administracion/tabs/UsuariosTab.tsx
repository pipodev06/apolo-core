    ...
    <div className="space-y-2">
      ...
      {loading ? (
        ...
        <div className="rounded-lg border border-dashed bg-card py-12 text-center">
          <UserIcon className="mx-auto mb-4 h-12 w-12 text-muted-foreground/40" />
            ...
            {paginados.map((user, i) => (
              <TableRow key={user.id}>
                ...
                <TableCell>
                  <div className="flex items-center">
                    {esAdmin(user.role) ? (
                      <Shield className={cn("mr-1 h-4 w-4", esSuperAdmin(user.role) ? "text-primary" : "text-muted-foreground")} />
                    ) : (
                    ...
                    {soloPapelera ? (
                      <>
                        ...
                        <button
                          ...
                          className="cursor-pointer rounded-md p-1.5 text-muted-foreground transition-colors hover:bg-destructive/10 hover:text-destructive disabled:cursor-not-allowed disabled:opacity-40 disabled:hover:bg-transparent"
                      ...
                      <>
                        <button
                          ...
                          className={cn(
                            ...
                            user.active ? "hover:bg-muted hover:text-foreground" : "hover:bg-green-500/10 hover:text-green-600"
                          )}
